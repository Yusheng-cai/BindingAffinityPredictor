...
additional affinity-prediction pathway. An example input can contain protein
...
I evaluated the released versions of all three models on the same frozen set
of 87 protein--ligand pairs. For each model, I preserved its native affinity
output and matched it to the experimental measurement only during the
subsequent analysis. The workflows differed mainly in how much structural
information they received and whether they generated a new complex.
...
Exact model revisions, checkpoints, inference settings, commands, hardware
records, and output definitions are given in the separate technical methods
report.
...
I reproduced the headline affinity-ranking result reported for each model on
...
with paper values of 0.80, 0.66, and 0.53, respectively. The absolute
differences were therefore 0.007, 0.033, and 0.003. This close agreement shows
